# -*- coding: utf-8 -*-
"""
https://github.com/c0redumb/yahoo_quote_download/blob/master/tests/test_yqd.py
...
def load_quote(ticker):
    print('===', ticker, '===')
    x=load_yahoo_quote(ticker, '20160515', '20170617')
    #print(load_yahoo_quote(ticker, '20160515', '20170617', 'dividend'))
    #print(load_yahoo_quote(ticker, '20160515', '20170617', 'split'))
    return x
def test():
    RESULTS = load_quote('QCOM')
    resultFyle = open("QCOM_quote.csv", 'w')
    for r in RESULTS:
        resultFyle.write(r + "\n")
    resultFyle.close()
    #load_quote('C')
